/**
 * dsh-auto-approval-plugin — configuration HTTP surface.
 *
...
export const CONFIG_PATH = "/api/dsh-auto-approval-plugin/config";
export const STATUS_PATH = "/api/dsh-auto-approval-plugin/status";
...
function assertTrustedAuthority(entry) {
  ...
  throw new Error(`dsh-auto-approval-plugin: trusted host ${JSON.stringify(entry)} is not a bare host[:port] authority`);
}
