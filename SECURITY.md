...
- The decision is lexical (path containment on normalized spellings); it does not resolve symlinks or junctions. The sandbox's own enforcement still applies to every non-escalated call.
